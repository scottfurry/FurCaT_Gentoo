...
MY_P="${PN}-${MY_PV}"
# Point Revision number of Release (e.g. ...SAS3.5_P##)
PT_REV="32"
MY_PN="STORCLI_SAS3.5_P${PT_REV}"
DESCRIPTION="MegaRAID StorCLI (successor of the MegaCLI)"
HOMEPAGE="https://www.broadcom.com/support/download-search?dk=storcli"
SRC_URI="https://docs.broadcom.com/docs-and-downloads/host-bus-adapters/host-bus-adapters-common-files/sas_sata_nvme_12g_p${PT_REV}/${MY_PN}.zip 
-> ${P}.zip"
